...
<<<<<<< HEAD
    int  x1, y1, x2, y2;
    printf("Введите координаты первого поля\n");
    scanf("%i %i", &x1, &y1 );

    while (x1 > 8 || x1 < 1 || y1 > 8 || y1 < 1) {
        printf("Неверно введены координаты. Введите координаты первого поля\n");
        scanf("%i %i", &x1, &y1 );
        break;
    }

    printf("Введите координаты второго поля\n");
    scanf("%i %i", &x2, &y2 );
    while (x2 > 8 || x2 < 1 || y2 > 8 || y2 < 1) {
        printf("Неверно введены координаты. Введите координаты второго поля\n");
        scanf("%i %i", &x2, &y2 );
        break;
    }
...
>>>>>>> db4e0aa695092c660e343cc3e012306550406511
void solution10()
{
int  a, b, c;
    int i = 1;
